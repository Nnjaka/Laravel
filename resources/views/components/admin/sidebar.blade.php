<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link @if(request()->routeIs('admin.feedback')) active @endif" href="{{ route('admin.feedback')}}">
            <span data-feather="book"></span>
            Обратная связь
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if(request()->routeIs('admin.unloadings.*')) active @endif" href="{{ route('admin.unloadings.index')}}">
