...
Route::get('/news/news/{news}', [NewsController::class, 'show'])
    ->where('news', '\d+')
    ->name('news.show');

Route::get('/news/category/{category}', [CategoryNewsController::class, 'index'])
    ->name('news.category');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin.check'], function () {
        ...
        Route::resource('unloadings', AdminUnloadingController::class);
    });
});
